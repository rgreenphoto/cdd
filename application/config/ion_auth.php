 ...
 */
$config['site_title']           = "Colorado Disc Dogs"; 		// Site Title, example.com
$config['admin_email']          = "admin@coloradodiscdogs.com"; 	// Admin Email, admin@example.com
...
/*
 ...
 | -------------------------------------------------------------------------
 */
$config['message_start_delimiter'] = '<p class="text-info">'; 	// Message start delimiter
