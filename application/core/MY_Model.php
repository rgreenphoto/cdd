...
*/
    public function get($primary_value)
    {
        ...
        if(isset($this->sort)) {
            $this->db->order_by($this->sort, $this->sort_dir);
        }
...
*/
    ...
    public function get_many_in($key, $options = array()) {
        if(isset($this->sort)) {
            $this->db->order_by($this->sort, $this->sort_dir);
        }                
        $this->db->where_in($key,$options);
...
*/
    public function update_by($args, $data)
    {
        $args = func_get_args();
        $data = array_pop($args);
