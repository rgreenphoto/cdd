...
class Auth extends CI_Controller {
		...
		else
		{
			...
			$this->data['password'] = array('name' => 'password',
				...
				'type' => 'password',
                        ...
                        $this->data['main'] = 'admin/auth/login';
	...
	function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			//render
                        $this->data['main'] = 'admin/auth/change_password';
                        $this->load->vars($this->data);
                        
			$this->load->view('admin/auth/layout');
		}
		else
		{
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->data['main'] = 'admin/auth/forgot_password';
                        $this->load->vars($this->data);
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				//render
                                $this->data['main'] = 'admin/auth/reset_password';
                                $this->load->vars($this->data);                  
				$this->load->view('admin/layout');
			}
			else
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->data['user'] = $this->ion_auth->user($id)->row();
                        $this->data['main'] = 'admin/auth/deactivate_user';
		...
		else
		{
			...
			$this->data['password_confirm'] = array(
				...
				'value' => $this->form_validation->set_value('password_confirm'),
                        ...
                        $this->data['main'] = 'admin/auth/create_user';
	...
	function edit_user($id)
	{
		...
		$this->data['main'] = 'admin/auth/edit_user';
                $this->load->view('admin/layout', $this->data);
	}
	...
	function edit_group($id)
	{
		...
		$this->load->view('admin/auth/edit_group', $this->data);
	}
