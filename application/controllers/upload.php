...
class Upload extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->setPath_img_upload_folder("uploads/profiles/");
		$this->setPath_img_thumb_upload_folder("uploads/profiles/");

		//Delete img url
		$this->setDelete_img_url(base_url() . 'admin/deleteImage/');

		//Set url img with Base_url()
		$this->setPath_url_img_upload_folder(base_url() . "uploads/profiles/");
		$this->setPath_url_img_thumb_upload_folder(base_url() . "uploads/profiles/");
	}
