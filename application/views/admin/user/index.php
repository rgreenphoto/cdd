...
<table class="table table-bordered table-hover table-striped footable toggle-circle toggle-medium">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo base_url(); ?>admin/user/edit/<?php echo $row->id; ?>" class="btn btn-cdd">Edit <i class="icon-edit"></i></a>
                <a href="<?php echo base_url(); ?>admin/user/delete/<?php echo $row->id; ?>" class="btn btn-danger">Delete <i class="icon-remove-circle"></i></a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
