        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="round_1">
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr class="danger">
                        ...
                        <td><input type="number" name="deduct_1" class="fs_1 form-control" id="deduct_1" step=".1" /></td>
                    </tr>
                    <tr class="success">
            ...
            <div class="tab-pane fade" id="round_2">
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr class="warning">
                        <th colspan="4" class="text-right">Catch Ratio</th>
                        <td><input type="number" name="cr_2" class="cr_2 form-control" id="cr_2" value="<?php echo $item->cr_2; ?>" step=".1" /></td>
                    </tr>
                    <tr class="danger">
                        <th colspan="4" class="text-right">Deduct</th>
                        <td><input type="number" name="deduct_2" class="fs_2 form-control" id="deduct_2" step=".1" /></td>
                    </tr>
                    <tr class="success">
