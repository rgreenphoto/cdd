<div class="cdd-nav-footer navbar navbar-inverse navbar-fixed-bottom hidden-lg hidden-md" role="navigation">
    ...
    <div class="collapse navbar-collapse footer-menu">
        <ul class="nav navbar-nav">
            <li><a href="<?php echo base_url(); ?>competition/demos">Demo Team</a></li>
