<div class="row">
    <div class="col-xs-4 col-xs-push-8 col-lg-3 col-lg-push-9">
        <img src="<?php echo base_url(); ?><?php echo $event->competition_type->large_image; ?>" class="img-responsive" />
    </div>
    <div class="col-xs-8 col-xs-pull-4 col-lg-9 col-lg-pull-3">
...
<div class="row">    
    <div class="col-lg-3 col-lg-push-9">
        ...
        <?php $date = date('Y-m-d'); if($event->registration_start <= $date && $event->registration_end >= $date): ?>
            ...
            <?php endif; ?>
            <hr />
            <a href="<?php echo base_url(); ?>competition/registered/<?php echo $event->slug; ?>" class="btn btn-sm btn-warning">View Registered Teams</a>
        <?php endif; ?> 
