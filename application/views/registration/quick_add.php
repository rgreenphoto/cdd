...
<div class="row">
    <div class="col-lg-12">
        <?php echo form_open('registration/quick_add/', array('method' => 'post', 'id' => 'quick-add-form'), $hidden); ?>
...
$(document).ready(function() {
   ...
   var group_id = '<?php echo !empty($group_id)?$group_id:''; ?>';
   $('#quick-add-form').submit(function(e) { 
      e.preventDefault();
      $('#ajax-loader').show();
      $.ajax({
         type: "POST",
         url: '<?php echo base_url(); ?>registration/quick_add/',
         data: form.serialize(),
